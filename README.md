...
## Usage
To use this tool, import the included package into your Unity project. Then place the following code on a persistent object such that its code gets executed at some point you know about:
```csharp
using AsmExplorer;
using UnityEngine;
